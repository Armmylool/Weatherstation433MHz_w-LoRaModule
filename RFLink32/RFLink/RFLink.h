...
#define MIN_RAW_PULSES 24               // 50         // Minimal number of bits that need to have been received before we spend CPU time on decoding the signal.
...
#define SIGNAL_MIN_PREAMBLE_US 100     // 3000       // After this time in mSec, a RF signal will be considered to have started.
